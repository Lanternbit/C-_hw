...
#### &nbsp;틀린그림찾기는 오래된 게임을 꾸준히 많은 사람들에게 사랑받고 있다. 이번 과제를 통해 C++를 이용하여 틀린그림찾기를 구현해 보았다.

### 2.2 필요성

#### &nbsp;틀린그림찾기는 지금 당장 검색하여 진행할 수 있는 누구나 아는 게임이다. 하지만 이 프로젝트를 진행함으로써 팀원들이 얻을 수 있는 경험을 생각해보았을 때 필요하다고 판단하였다. C++을 사용하여 그림을 출력하고, 제한 시간, 정답 구역 설정 및 메인, 종료 화면 출력 등 게임의 기본적인 기능이나 구조를 골고루 경험해볼 수 있을 것이다. 
